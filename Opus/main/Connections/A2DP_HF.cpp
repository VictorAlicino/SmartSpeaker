...
void A2DP_HF::config(std::string device_name, std::string remote_name, bluetooth_service_mode_t mode){
...
void bluetooth_service_hf_client_cb(esp_hf_client_cb_event_t event, esp_hf_client_cb_param_t *param){
